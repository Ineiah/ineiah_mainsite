<template>
  <article :id="createElementId('service', 'content', service.gender, service.category, service.name || `${index + 1}`)" class="relative bg-surface-200 cursor-pointer rounded-lg" @click="() => toggleServiceDetails()">
