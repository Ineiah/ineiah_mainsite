<template>
  <article :id="createElementId('link', 'service', service.gender, service.category, service.name || `${index + 1}`)" class="relative bg-surface-200 cursor-pointer rounded-lg" @click="() => toggleServiceDetails()">
